...
- Current local CLI surfaces still log row evidence in `.local/evals.sqlite`.
  ...
  carried as closed proof, and the colour-boundary audit pulse at
  `20154..20158` is the latest closed proof surface. The corrected split stack
  at `20097..20105` stays carried as the neutral correction. The full parked
