...
current stack has thirty-four bounded pulses after the first three warm-edge
audit passes.
...
| prior pulse size | `15` |
| carried warm-edge pulse sizes | `8`, `11` |
| pulse size | `6` |
| carried prior proof surface | `20106..20120` |
| carried warm-edge proof surfaces | `20121..20128`, `20129..20139` |
| active proof surface | `20140..20145` |
| corrected split stack | `20097..20105` |
| pulse verdict | `PASS` |
| carried prior anchors | `14` |
| carried warm-edge anchors | `8`, `11` |
| anchors | `6` |
...
- use `430_WARM_EDGE_AUDIT` to choose the next warm-edge group and seed mode
  after the `20121..20128` pass
- keep `20129..20139` as the second warm-edge audit pass before choosing the
  next warm-edge group
- keep `20140..20145` as the third warm-edge audit pass before choosing the
  next warm-edge group
...
10. use `430_WARM_EDGE_AUDIT` to choose the next warm-edge group before
   launching another pulse
