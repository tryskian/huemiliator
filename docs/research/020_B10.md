...
current stack has thirty-seven bounded pulses after the first five warm-edge
audit passes and the first colour-boundary report pass.
...
| latest proof surface | `20154..20158` |
...
- use `440_COLOUR_BOUNDARY_AUDIT` as the first report-derived boundary audit
  note
...
13. keep the closed warm-edge residue map unless new evidence appears
