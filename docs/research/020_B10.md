...
current stack has thirty-two bounded pulses after the first warm-edge audit
pass.
...
| active proof surface | `20121..20128` |
...
8. use `430_WARM_EDGE_AUDIT` to choose the next warm-edge group before
