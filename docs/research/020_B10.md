...
current stack has thirty-eight bounded pulses after the first five warm-edge
audit passes and the first two colour-boundary report passes.
...
| carried colour-boundary pulse sizes | `5` |
| latest pulse size | `4` |
...
14. keep the closed warm-edge residue map unless new evidence appears
