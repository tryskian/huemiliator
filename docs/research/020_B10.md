...
current stack has thirty-nine bounded pulses after the first five warm-edge
audit passes and the first three colour-boundary report passes.
...
- one explicit-input warm-neutral audit pulse that closes the peach / pearl
  residue cleanly
- one explicit-input colour-boundary report pulse that closes the warm
  low-chroma five-family bin cleanly
- one explicit-input colour-boundary report pulse that closes the neutral /
  brown / orange / yellow bin cleanly
- one explicit-input colour-boundary report pulse that closes the neutral /
  pink / brown / red bin cleanly

Fail-pressure pulse is no longer a staged boundary. It is the closed
`Beta 1.0` method surface for non-OCR Huemiliator eval work until fresh
evidence promotes another boundary.

## Closed Pulse Snapshot

These are historical colour-pulse results. The current wording judgments for
`20163..20166` are four Peanut **FAILs**, recorded in the September 20
[correction](230_CARRIED_WORDING.md).
...
| prior pulse size | `15` |
| carried warm-edge pulse sizes | `8`, `11`, `6`, `5`, `3` |
| carried colour-boundary pulse sizes | `5`, `4` |
| latest pulse size | `4` |
| carried prior proof surface | `20106..20120` |
| carried warm-edge proof surfaces | `20121..20128`, `20129..20139`, `20140..20145`, `20146..20150`, `20151..20153` |
| carried colour-boundary proof surfaces | `20154..20158`, `20159..20162` |
| latest proof surface | `20163..20166` |
| corrected split stack | `20097..20105` |
| latest pulse verdict | `PASS` |
| carried prior anchors | `14` |
| carried warm-edge anchors | `8`, `11`, `6`, `5`, `3` |
| carried colour-boundary anchors | `5`, `4` |
| anchors | `4` |
...
The current `Beta 1.0` proof surface was reached through the baseline archive
...
- prior row-order `Beta 1.0` pulse:
  - `carried neutral proof surface 20106..20120`
  - `15` archived rows
- first warm-edge explicit-input `Beta 1.0` pulse:
...
- second warm-edge explicit-input `Beta 1.0` pulse:
...
- third warm-edge explicit-input `Beta 1.0` pulse:
...
- fourth warm-edge explicit-input `Beta 1.0` pulse:
...
- fifth warm-edge explicit-input `Beta 1.0` pulse:
  - `warm-neutral peach pearl residue 20151..20153`
  - `3` archived rows
  - `.local/parked/eval-surface-20260803T215237Z-beta-1-0-boundary-balanced-warm-low-chroma-preflight.jsonl`
- first colour-boundary explicit-input `Beta 1.0` pulse:
  - `colour-boundary warm low-chroma five-family bin 20154..20158`
  - `5` archived rows
  - `.local/parked/eval-surface-20260803T220104Z-beta-1-0-colour-boundary-warm-low-chroma-five-family-pass.jsonl`
- second colour-boundary explicit-input `Beta 1.0` pulse:
  - `colour-boundary neutral brown orange yellow bin 20159..20162`
  - `4` archived rows
  - `.local/parked/eval-surface-20260803T220515Z-beta-1-0-colour-boundary-neutral-brown-orange-yellow-pass.jsonl`
- latest explicit-input `Beta 1.0` pulse:
  - `colour-boundary neutral pink brown red bin 20163..20166`
  - `4` live rows
  - `.local/evals.sqlite`
...
That keeps the live DB truthful to one latest proof surface at a time.
...
- broader corrected neutral continuation before the warm-edge audit:
  - `15 total / 14 pass / 1 fail / 0 pending`
- first colour-boundary report pulse:
  - `5 total / 5 pass / 0 fail / 0 pending`
- second colour-boundary report pulse:
  - `4 total / 4 pass / 0 fail / 0 pending`
- third colour-boundary report pulse:
  - `4 total / 4 pass / 0 fail / 0 pending`

The row-level rerun stays important as the closed comparison baseline, but the
current verdict unit is now the bounded pulse and the latest proof surface is the
...
That question moved into closed audit notes:

- use `430_WARM_EDGE_AUDIT` as the closed warm-edge residue audit note
...
- use `440_COLOUR_BOUNDARY_AUDIT` as the report-derived boundary audit note
...
- keep the closed warm-edge residue map and colour-boundary audit unless new
  evidence appears
...
5. use `420_RESIDUE` to choose the next method or scope before launching
   another pulse
6. use `420_RESIDUE` as the closed source residue map
...
12. keep `20154..20158` as the first colour-boundary audit pass
13. keep `20159..20162` as the second colour-boundary audit pass
14. keep `20163..20166` as the third colour-boundary audit pass
15. keep the closed warm-edge residue map unless new evidence appears
