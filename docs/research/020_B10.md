...
The first thirty-one bounded pulses now read like this:
...
| pulse source-order start | `48` |
| pulse size | `15` |
| active proof surface | `20106..20120` |
...
- current live row-order `Beta 1.0` pulse:
