...
The previous live `neutral` proof surface was quarantined locally before this
pulse:
...
| 2 | `yellow` green / olive shoulder | `19723`, `19729`, `19730`, `19733`, `19734`, `19735`, `19737`, `19738`, `19741`, `19742`, `19743`, `19746`, `19747`, `19749`, `19750`, `19751` | `16` | repeated yellow-to-green pressure; corrected and parked | cohort or exact inputs |
| 3 | `orange` pale straw / buff / blush shoulder | `19918`, `19919`, `19920`, `19921`, `19922`, `19923` | `6` | pale warm orange shoulder; corrected and parked | exact inputs preferred |
...
| keep live DB clean | no new pulse starts until the current `20121..20128` proof surface is intentionally replaced or quarantined |

## Recommendation

Use the `yellow` green / olive shoulder as the next candidate if the warm-edge
audit continues. The first `orange` yellow-gold boundary pulse already passed
cleanly, so do not rerun it without new evidence.
